...
class Split2d(nn.Module):
    def __init__(self, num_channels, logs_eps=0, cond_channels=0, position=None, consume_ratio=0.5, opt=None):
        ...
        self.num_channels_pass = num_channels - self.num_channels_consume#分割成一半

        self.conv = Conv2dZeros(in_channels=self.num_channels_pass + cond_channels,#cond_channels是0
