...
class Restormer(nn.Module):
    def __init__(self,
        ...
        self.decoder_level1 = nn.Sequential(*[
            TransformerBlock(dim=int(dim * 2 + dim), num_heads=heads[0], ffn_expansion_factor=ffn_expansion_factor,
        ...
        self.output = nn.Conv2d(int(dim * 2 + dim), inp_channels, kernel_size=3, stride=1, padding=1, bias=bias)
        #self.skip = nn.Conv2d(int(inp_channels), out_channels, kernel_size=1, bias=bias)

    def forward(self, inp_img, result):
...
if __name__ == '__main__':
    ...
    # mean_gray_out = cv2.cvtColor(x.astype(numpy.float32), cv2.COLOR_BGR2GRAY).mean()
    # print(mean_gray_out)
    # print(x[0].shape)